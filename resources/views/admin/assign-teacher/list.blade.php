          ...
          @endforeach
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach ($assignTeachers as $item)
            <tr>
            <td>{{ $item->id }}</td>
            ...
            <td><a href="{{ route('assign-teacher.edit', $item->id) }}" class="btn btn-primary">Edit</a></td>
            <td><a href="{{ route('assign-teacher.delete', $item->id) }}"
