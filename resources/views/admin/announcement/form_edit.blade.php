                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                       ...
                                       form-control">
                                            ...
                                            <option value="student" {{ $announcement->type == 'student' ? 'selected' : null}}>student</option>
                                            <option value="teacher" {{ $announcement->type == 'teacher' ? 'selected' : null}}>teacher</option>
                                            <option value="parent" {{ $announcement->type == 'parent' ? 'selected' : null}}>parent</option>
                                        </select>
                                        @error('message')
                                            <p class="text-danger">{{ $message }}</p>
                                            </p>
